...
<div align="center">
  ...
  <p><b>Claude Code 和多编辑器的可视化配置控制台</b></p>
  <p><i>不被看见，价值难现。</i></p>

  <p>把 MCP、Skill、Hook、Subagent、Command 从分散的 JSON 文件里解放出来，<br/>集中管理、测试验证、一键同步。</p>
...
<!--
[待补充] MCP 测试 GIF — 演示连接测试与 Tool 执行流程（中文 UI）
...
就绪后替换下方图片：
-->
![MCP 测试](./imgs/mcp-testing-12s.gif)
...
更新：`brew upgrade --cask linhai0872/tap/claude-code-tool-manager`
